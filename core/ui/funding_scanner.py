                ...
                for j in range(i + 1, len(lst)):
                    ...
                    if best is None or abs(net) > abs(best["net_apr"]):
                        best = {
                            ...
                            "short_apr": high.apr,
                            "volume_24h_short": high.volume_24h,
                            "open_interest_short": high.open_interest,
                            "long_venue": low.venue,
                            "long_venue_type": low.venue_type,
                            "long_rate": low.rate,
                            "long_interval_h": low.interval_h,
                            "long_apr": low.apr,
                            "volume_24h_long": low.volume_24h,
                            "open_interest_long": low.open_interest,
                            "volume_24h": min(high.volume_24h, low.volume_24h),
                            "open_interest": min(high.open_interest, low.open_interest),
                            "risk": high.risk if high.risk != "LOW" else low.risk,
                            "net_apr": net,
