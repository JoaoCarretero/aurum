...
# Scan hook — wraps MILLENNIUM's _collect_live_signals and filters to
# this engine. Using the same collector (not calling the engine directly)
# guarantees signals match what MILLENNIUM would see for this engine on
# the same candles, so cross-validation is clean.
