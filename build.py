...
PyInstaller.__main__.run([
    ...
    "--hidden-import=engines.citadel",
    "--hidden-import=engines.live",
    "--hidden-import=engines.deshaw",
    "--hidden-import=engines.jump",
    "--hidden-import=engines.bridgewater",
    "--hidden-import=engines.twosigma",
    "--hidden-import=engines.aqr",
    "--hidden-import=engines.millennium",
    "--hidden-import=engines.janestreet",
